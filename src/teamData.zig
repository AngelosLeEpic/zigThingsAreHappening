...
const TEAM_NAMES = [_][]const u8{ "Liverpool", "Manchester City", "Arsenal", "Aston Villa", "Brentford", "Brighton", "Chelsea", "Fulham", "Newcastle", "Nottingham Forest", "Tottenham", "Bournemouth", "Manchester United", "West Ham", "Everton", "Leicester ", "Crystal Palace", "Ipswich Town", "Southampton", "Wolves" };
